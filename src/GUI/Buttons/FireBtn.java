...
public class FireBtn extends JButton {
    ...
    public FireBtn(final int width, final int height, final int posX, final int posY) {
        this.width = width;
        this.height = height;

        this.enabledIcon = new ImageIcon(getClass().getResource("/Img/Buttons/9. Fire (Enable).png"));
        this.disabledIcon = new ImageIcon(getClass().getResource("/Img/Buttons/10. Fire (Disable).png"));
